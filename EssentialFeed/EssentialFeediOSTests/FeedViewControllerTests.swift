...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadFeedActions_requestFeedFromLoader() {
        ...
        XCTAssertEqual(loader.loadFeedCallCount,0, "Expected no loading requests before view is laoded")
        
        sut.loadViewIfNeeded()
        XCTAssertEqual(loader.loadFeedCallCount, 1, "Expected a loading request once view is loaded")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 2, "Expected another loading request after user initiates reload")
    ...
    func test_feedIMageView_canclesImageLoadingWhenNotVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "https://url-0.com")!)
        let image1 = makeImage(url: URL(string: "https://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator state change for first view once secon image loading completes with error")
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action once image loading completes with incvalid imagedata")
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url], "Excpected third imageURL request afrter first view retry action")
        
        view1?.simulateRetryAction()
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url, image1.url], "Excpected fourth imageURL request afrter first view retry action")
    ...
    func test_feedImageView_cancelsURLPreLoadingWhenNotNearVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    class LoaderSpy: FeedLoader, FeeedImageDataLoader {
        ...
        private var imageRequests = [(url: URL, completion: (FeeedImageDataLoader.Result) -> Void)]()
        ...
        func loadImageData(from url: URL, completion: @escaping (FeeedImageDataLoader.Result) -> Void) -> FeedImageDataLoaderTask {
